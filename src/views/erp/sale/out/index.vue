  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="客户" prop="customerId">
        <el-select v-model="queryParams.customerId"  clearable filterable placeholder="请选择客户" class="!w-240px" >
      ...
      <el-form-item label="创建人" prop="creator">
        <el-select v-model="queryParams.creator"  clearable filterable placeholder="请选择创建人" class="!w-240px" >
          <el-option v-for="[id, name] in userItem" :key="id" :value="name" :label="name" />
        </el-select>
      </el-form-item>
...
const { materialItem, customerItem, userItem, accountItem, warehouseItem } = useBasicData()
