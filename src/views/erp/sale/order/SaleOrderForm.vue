  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1440">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="客户订单号" prop="no">
            <el-input v-model="formData.customerOrderNo" placeholder="请输入客户订单号" />
          </el-form-item>
        </el-col> 
        <el-col :span="8">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="客户" prop="customerId">
            <el-select v-model="formData.customerId"  clearable filterable placeholder="请选择客户" class="!w-240px" >
        ...
        <el-col :span="8">
          <el-form-item label="销售人员" prop="saleUserId">
            <el-select v-model="formData.saleUserId"  clearable filterable placeholder="请选择销售人员" class="!w-240px" >
              <el-option v-for="[id, name] in userItem" :key="id" :value="id" :label="name" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="附件" prop="fileUrl" v-if="false">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="结算账户" prop="accountId">
            <el-select v-model="formData.accountId"  clearable filterable placeholder="请选择结算账户" class="!w-240px" >
...
const { customerItem, accountItem, userItem, defaultAccountId } = useBasicData()
