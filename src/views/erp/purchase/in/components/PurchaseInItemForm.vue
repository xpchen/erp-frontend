<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px">
      ...
      <el-table-column label="金额" prop="totalMaterialPrice" fixed="right" min-width="100" v-if="checkPermi(['erp:amount:view'])">
        <template #default="{ row, $index }">
      ...
      <el-table-column label="税率（%）" fixed="right" min-width="115" v-if="checkPermi(['erp:amount:view'])">
        <template #default="{ row, $index }">
      ...
      <el-table-column label="税额" prop="taxPrice" fixed="right" min-width="120" v-if="checkPermi(['erp:amount:view'])">
        <template #default="{ row, $index }">
      ...
      <el-table-column label="税额合计" prop="totalPrice" fixed="right" min-width="100" v-if="checkPermi(['erp:amount:view'])">
        <template #default="{ row, $index }">
