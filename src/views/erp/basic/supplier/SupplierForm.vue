  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="采购周期(天)" prop="purchasingCycle" label-width="102px">
            <el-input-number
...
const formRules = reactive({
  ...
  purchasingCycle: [{ required: true, message: '采购周期不能为空', trigger: 'blur' }]
})
