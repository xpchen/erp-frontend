<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="供应商编码" prop="supplierCode" label-width="85px">
        <el-input
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="账期(天)" align="center" prop="accountPeriod" />
      <el-table-column label="采购周期(天)" align="center" prop="purchasingCycle" />
