<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="物料信息" align="center" prop="materialNames" min-width="180" />
      <el-table-column label="物料规格" align="center" prop="materialStandards" min-width="240">
...
const { materialInfoArray, warehouseItem, supplierItem, userItem } = useBasicData()
