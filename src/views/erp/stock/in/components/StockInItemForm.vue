...
const { warehouseItem, materialInfoArray, materialItem, defaultWarehouseId } = useBasicData()
import {
...
const onChangeMaterial = (materialId, row) => {
  // 检查 materialInfoArray.value 是否为数组
  if (Array.isArray(materialInfoArray.value)) {
