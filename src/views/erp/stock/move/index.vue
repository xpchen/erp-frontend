  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="仓库" prop="fromWarehouseId">
        <el-select v-model="queryParams.fromWarehouseId"  clearable filterable placeholder="请选择仓库" class="!w-220px" >
...
const { materialInfoArray, warehouseItem, userItem } = useBasicData()
