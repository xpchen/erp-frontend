...
import { MaterialRequirementPlanApi, MaterialRequirementPlanVO} from '@/api/erp/produce/materialrequirementplan'
import MaterialRequirementPlanItemsForm from './components/MaterialRequirementPlanItemsForm.vue'
...
const handleIssueTask = async () => {
  try {
    ...
    await MaterialRequirementPlanApi.mrpTaskDispatch(data)
