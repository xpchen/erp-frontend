<template>
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['erp:produce-process:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['erp:produce-process:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <ProduceProcessForm ref="formRef" @success="getList" />
</template>
...
import ProduceProcessForm from './ProduceProcessForm.vue'
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await ProduceProcessApi.deleteProduceProcess(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await ProduceProcessApi.exportProduceProcess(queryParams)
    download.excel(data, '工艺工序.xls')
  } catch {
  } finally {
