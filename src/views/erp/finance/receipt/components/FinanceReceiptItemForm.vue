<template>
  ...
  >
    <el-table :data="formData" show-summary :summary-method="getSummaries" class="-mt-10px">
      ...
      <el-table-column label="应收金额" prop="totalPrice" fixed="right" min-width="100" align="center">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
            <el-input-number :disabled="amountEditable"  v-model="row.totalPrice" :formatter="erpPriceInputFormatter" controls-position="right"/>
          </el-form-item>
        </template>
      </el-table-column>
      <el-table-column label="已收金额" prop="receiptedPrice" fixed="right" min-width="100" align="center">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
            <el-input-number :disabled="amountEditable"  v-model="row.receiptedPrice" :formatter="erpPriceInputFormatter" controls-position="right"/>
          </el-form-item>
        </template>
      </el-table-column>
      <el-table-column label="本次收款" prop="receiptPrice" fixed="right" min-width="115" align="center" >
  ...
  <el-row justify="center" class="mt-3" v-if="!disabled">
    <el-button @click="handleReceipt" round>+ 添加收款单</el-button>
